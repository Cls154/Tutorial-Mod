...
import net.cieran.tutorialmod.block.custom.EggplantPlantBlock;
...
public class ModBlockLootTables extends BlockLoot {
    ...
    protected void addTables() {
        ...
        this.add(ModBlocks.CITRINE_ORE.get(), (block) -> createOreDrop(ModBlocks.CITRINE_ORE.get(), ModItems.RAW_CITRINE.get()));
        this.add(ModBlocks.DEEPSLATE_CITRINE_ORE.get(), (block) -> createOreDrop(ModBlocks.DEEPSLATE_CITRINE_ORE.get(), ModItems.RAW_CITRINE.get()));
        this.add(ModBlocks.NETHERRACK_CITRINE_ORE.get(), (block) -> createOreDrop(ModBlocks.NETHERRACK_CITRINE_ORE.get(), ModItems.RAW_CITRINE.get()));
        this.add(ModBlocks.ENDSTONE_CITRINE_ORE.get(), (block) -> createOreDrop(ModBlocks.ENDSTONE_CITRINE_ORE.get(), ModItems.RAW_CITRINE.get()));
        ...
        LootItemCondition.Builder lootitemcondition$builder = LootItemBlockStatePropertyCondition
                .hasBlockStateProperties(ModBlocks.EGGPLANT_PLANT.get())
                .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(EggplantPlantBlock.AGE, 5));

        this.add(ModBlocks.EGGPLANT_PLANT.get(), createCropDrops(ModBlocks.EGGPLANT_PLANT.get(), ModItems.EGG_PLANT.get(),
                ModItems.EGGPLANT_SEEDS.get(), lootitemcondition$builder));
    }
