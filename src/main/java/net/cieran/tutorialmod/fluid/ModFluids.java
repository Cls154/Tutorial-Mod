package net.cieran.tutorialmod.fluid;
...
public class ModFluids {
    ...
    public static final ForgeFlowingFluid.Properties HONEY_PROPERTIES = new ForgeFlowingFluid.Properties(
            ...
            .color(0xbffcba03)).slopeFindDistance(2).levelDecreasePerBlock(2).block(() -> ModFluids.HONEY_BLOCK.get()).bucket(() -> ModItems.HONEY_BUCKET.get());
