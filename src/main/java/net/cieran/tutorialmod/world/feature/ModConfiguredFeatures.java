...
public class ModConfiguredFeatures {
    ...
    public static final Holder<PlacedFeature> EBONY_CHECKED =
            PlacementUtils.register("ebony_checked", EBONY_TREE, PlacementUtils.filteredByBlockSurvival(ModBlocks.EBONY_SAPLING.get()));
    ...
    public static final Holder<ConfiguredFeature<RandomFeatureConfiguration, ?>> EBONY_SPAWN =
            FeatureUtils.register("ebony_spawn", Feature.RANDOM_SELECTOR,
                    new RandomFeatureConfiguration(List.of(
                            new WeightedPlacedFeature(EBONY_CHECKED, 0.5F)),
                            EBONY_CHECKED));



    public static final Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> FLOWER_PINK_ROSE =
    ...
    public static final Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_CITRINE =
            FeatureUtils.register("ore_citrine", Feature.ORE, new OreConfiguration(ORE_CITRINE_TARGET_LIST, 9));
