package net.cieran.tutorialmod.screen;
...
import net.cieran.tutorialmod.screen.slot.ModResultSlot;
...
public class GemCuttingStationMenu extends AbstractContainerMenu {
    ...
    public int getScaledProgress() {
        ...
        int progressArrowSize = 26; // This is height of arrow in pixels
