package net.cieran.tutorialmod.block.entity.custom;
...
import net.cieran.tutorialmod.screen.GemCuttingStationMenu;
...
public class GemCuttingStationBlockEntity extends BlockEntity implements MenuProvider {
    ...
    public GemCuttingStationBlockEntity(BlockPos pWorldPosition, BlockState pBlockState) {
        ...
        this.data = new ContainerData() {
            ...
            public void set(int pIndex, int pValue) {
                switch (pIndex) {
                    case 0: GemCuttingStationBlockEntity.this.progress = pValue; break;
                    case 1: GemCuttingStationBlockEntity.this.maxProgress = pValue; break;
                }
            }
    ...
    private static boolean hasRecipe(GemCuttingStationBlockEntity entity) {
        ...
        Optional<GemCuttingStationRecipe> match = level.getRecipeManager().getRecipeFor(GemCuttingStationRecipe.Type.INSTANCE, inventory, level);
    ...
    private static void craftItem(GemCuttingStationBlockEntity entity) {
        ...
        if (match.isPresent()) {
            ...
            entity.itemHandler.setStackInSlot(3,
                    new ItemStack(match.get().getResultItem().getItem(), entity.itemHandler.getStackInSlot(3).getCount() + 1));
